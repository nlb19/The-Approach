...
const LoginForm = () => {
  ...
  return (
    <FormWrapper error={error} handleSubmit={handleSubmit}>
      <h1 className="text-2xl font-bold leading-none">Login<br></br><span className="text-sm text-gray-500 leading-tight">If you don't have an account yet, <Link to="/auth/register" className="underline font-italic font-bold leading-tight hover:text-charcoal text-charcoal">register</Link></span></h1>
